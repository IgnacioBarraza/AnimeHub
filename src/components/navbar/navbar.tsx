          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isProfileDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-background-light rounded-md shadow-lg py-1">
                {isLoggedIn ? (
                    <>
                      <Link to="/account" className="block px-4 py-2 text-sm hover:bg-background-lighter">
                        My Account
                      </Link>
                      <Link to="/settings" className="block px-4 py-2 text-sm hover:bg-background-lighter">
                        Settings
                      </Link>
                      <button
                    ...
                    <>
                      <Link to="/login" className="block px-4 py-2 text-sm hover:bg-background-lighter">
                        Login
                      </Link>
                      <Link to="/register" className="block px-4 py-2 text-sm hover:bg-background-lighter">
                        Register
                      </Link>
                    </>
                  )}
